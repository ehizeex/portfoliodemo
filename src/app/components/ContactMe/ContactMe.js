    ...
    <React.Fragment>
      ...
      <div className="z-20 relative">
        <div className=" justify-center flex content-center">
          <p className="text-[#48AFDE] font-bold  text-7xl "> Hire Me</p>
        </div>
        <div className=" text-center  mt-5 justify-center flex ">
          <p className="text-white font-[300] w-[650px]  text-center   text-xl ">
            Are you looking for a responsible, professinal full-stack developer
            and designer for your website or your web application projects? Just
            leave me a message and tell me how I can help.
          </p>
        </div>
      </div>
...
{/* form fields */}
      <div className={` ${hind.className} flex justify-center items-center`}>
          ...
          <form>
            ...
            <div class="mb-6">
              ...
              <input
                ...
                onChange={handleChange}
                class="bg-[#EEF7FB]  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5 "
                placeholder="Do you have any project"
              />
            </div>
            <div class="mb-6">
              <label
