...
// we wanna make sure this is responsive in all  platform, for that reason,
// we have to tagert all the breakpoints .
// copy and  passte it  8 times
            ...
            <div className="slider-card flex" style={{ paddingLeft: "0px" }}>
              ...
              >
                <div className=" flex">
                  ...
                  <div className="flex flex-col gap-x-4 md:flex-col mb:items-center">
                    <div className="font-medium text-base">Toni Peter</div>
                    <div
                      className={`font-[300] ${hind.className} font-medium text-[#48AEDD]`}
                    >
                      Youtube Student
