...
import Accordion from "../Footer/accordian";
...
const Footer = () => {
  ...
  return (
    <div id="footer">
      ...
      {/*footer  info section*/}
      <div className=" bg-[#E0F3FB] lg:pt-[100px] pt-[0px]">
        {/*designing the get started box*/}
        <div
          className="max-w-[1140px] bg-[#2584ff] rounded-xl sm:px-[64px] px-[20px]  py-[64px] m-auto"
          style={{ transform: "translate(0px,70px)" }}>
          <div className="grid grid-cols-12">
            <div className="lg:col-span-9 col-span-12">
              <p className="text-[30px] text-white lg:text-start text-center">
                Ready to Get Started?
              </p>
              <p className="text-white font-sans lg:text-start text-center">
            ...
            <div className="lg:col-span-3 col-span-12">
              <div className="flex justify-center lg:mt-0 mt-5 ">
                <a className="font-sans cursor-pointer px-10 py-5 bg-[#01D9FF] rounded-full text-white font-medium text-lg">
                Sign Up Now
                </a>
              </div>
            </div>
      ...
      {/*
      To proceed  with the  footer, lets quickly copy and pate the datas required  
      implementing the major footer */}
      <footer class="bg-[#232323] ">
        <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8 ">
          <div className="container mx-auto p-4 md:hidden block mt-10">
            {/*this will make it assume the dimensions of all devices
          However, we want to display it on mobile devices only 
          // the n ext  inline is  to  render the  accordian component and  pass title and content as  props 
          */}
            ...
            <Accordion title="Legal" content={legal} />

            {/*implementin  the logo on mobile devices. so if you have ur own logo, you can use it here*/}
            <div className="md:hidden block">
              <div class="text-teal-600 flex justify-center mt-10">
                {/*this is the logo svg*/}
                <svg
                  class="h-8"
                  viewBox="0 0 80 24"
                  fill="none"
              ...
              <p class="mt-4 max-w-xs text-[#7b858b] font-sans text-center">
                You deserve it to be seen
              </p>
              <p class="text-xs text-[#7b858b] font-sans mt-5 text-center">
                &copy; 2023. edubaba.
              </p>
            </div>
          </div>
          {/*you wont see the logo on large  devices but  only on  a small device*/}

          {/*implementing the footer on larger device*/}
          <div class="grid  gap-6 grid-cols-5 md:pt-20 ">
            <div className="md:block hidden">
              <div class="text-[#2584ff]">
                <svg
                  class="h-8"
                  viewBox="0 0 80 24"
                  fill="none"
              ...
              <p class="mt-4 max-w-xs text-[#7b858b] font-sans">
                you deserve it to be seen!
              </p>
              <p class="text-xs text-[#7b858b] font-sans mt-5">
                &copy; 2023. edubaba.
              </p>
            </div>
            {/*end of logo div*/}

            {/*Lets quickly map  through the items and have  them displayed on the screen*/}
            <div className="md:block hidden">
              {" "}
              {/*this  will be hiden on media devices*/}
              <p class="font-medium text-white font-sans">Services</p>
              {/*lets map through the item  services. */}
              <ul class="mt-6 space-y-4 text-sm">
                {service.map((item) => (
                  <li>
                    <a
                      href="#"
                      class="text-[#7b858b] font-sans transition hover:opacity-75">
                      {item}
                    </a>
                  </li>
                ))}
            ...
            {/*lets map through the item  companies. */}
            <div className="md:block hidden">
              <p class="font-medium text-white font-sans">Company</p>
            ...
            {/*lets map through the item  to  display the  Helpful link. */}
            <div className="md:block hidden">
              <p class="font-medium text-white font-sans">Helpful Links</p>
            ...
            {/*lets map through the item  to  display t he legal details. */}
            <div className="md:block hidden">
              <p class="font-medium text-white font-sans">Legal</p>
              <ul class="mt-6 space-y-4 text-sm">
                {legal.map((item) => (
                  <li>
                    <a
          ...
          {/* Footer Item  implementation on larger devices ends here  */}




          {/*Footer Social  Icons implementation  */}

          <div class="xl:max-w-6xl 2xl:max-w-7xl px-10 md:px-20 xl:px-44 mx-auto   sm:py-10 overflow-hidden">
            <div class="flex flex-wrap justify-between items-center">

              <div class="w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0">
                <a
                  href="https://twitter.com/iman82gm"
                  target="_blank"
                  ...
                  <h5 class="font-recoleta mt-1 lg:mt-3 xl:mt-5 text-sm sm:text-base font-sans text-gray-300 transition-colors duration-300 group-hover:text-[#48AFDE]">
                    Twitter
                  </h5>
                </a>
              </div>

              {/*highlight line ,,,,, to ,,,,,  duplicate it five times */}

              <div class="w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0">
                <a
                  href="https://github.com/imangm/"
                  target="_blank"
                  class="group flex flex-col items-center justify-center">
                  <svg
                    stroke="currentColor"
              ...
              <div class="w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0">
                <a
                  href="https://dribbble.com/ImanGM/"
                  target="_blank"
                  class="group flex flex-col items-center justify-center">
                  <svg
                    stroke="currentColor"
              ...
              <div class="w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0">
                <a
                  href="https://www.linkedin.com/in/imanthegm/"
                  target="_blank"
                  class="group flex flex-col items-center justify-center">
                  <svg
                    stroke="currentColor"
              ...
              <div class="w-1/3 sm:w-auto sm:mx-4 mb-10 sm:mb-0">
                <a
                  href="https://www.instagram.com/imangm/"
                  target="_blank"
                  class="group flex flex-col items-center justify-center">
                  <svg
                    stroke="currentColor"
